...
export function AppHeader() {
  ...
  const notificationTrigger = (
    <DialogTrigger asChild>
      <button type="button" className="relative p-2 rounded-full bg-card hover:bg-accent">
        ...
        <>
         <header className="md:hidden flex items-center justify-between p-4 h-20 border-b border-border bg-background/80 backdrop-blur-xl sticky top-0 z-30 rounded-b-3xl">
            ...
            <div className="flex items-center gap-2">
                ...
                <button type="button" className="h-9 w-9 rounded-full p-0.5 cursor-pointer" onClick={() => open({ view: 'Account' })}>
