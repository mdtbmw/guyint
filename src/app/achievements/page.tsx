...
export default function AchievementsPage() {
  ...
  return (
    <div className="space-y-12">
        <PageHeader title="Artifacts" description="Milestones that mark your prediction journey." />
            ...
            <div className="w-full xl:w-3/5">
                <div className="animate-slide-up" style={{ animationDelay: '100ms' }}>
                    <div className="flex items-center justify-between mb-6">
                        <h2 className="font-display text-2xl font-bold text-foreground">Unlocked Artifacts</h2>
                        <div className="flex gap-2">
                            <span className="text-xs text-muted-foreground bg-card px-3 py-1.5 rounded-full border border-border">{achievements.filter(a => stats && a.criteria(stats)).length} / {achievements.length}</span>
                        </div>
                    </div>
