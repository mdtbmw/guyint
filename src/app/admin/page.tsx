                    ...
                    <table className="min-w-full divide-y divide-border">
                        <thead className="bg-muted/50">
                            <tr>
                                ...
                                <th className="px-4 py-3 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Trust Score</th>
                                <th className="px-4 py-3 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Accuracy</th>
                        ...
                        <tbody className="bg-card divide-y divide-border">
                            {leaderboardData.slice(0, 100).map((user, index) => (
                                <tr key={user.id}>
                                    ...
                                    <td className="px-4 py-4 whitespace-nowrap text-sm text-foreground font-semibold">{user.trustScore.toFixed(2)}</td>
                                    <td className="px-4 py-4 whitespace-nowrap text-sm text-emerald-500">{user.accuracy.toFixed(2)}%</td>
                                    <td className="px-4 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <Button size="icon" variant="ghost" onClick={() => handleCopy(user.id)}><Copy className="w-4 h-4 text-muted-foreground"/></Button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
