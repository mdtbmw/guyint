    ...
    const handleDownload = useCallback(() => {
        ...
        toPng(qrCardRef.current, { cacheBust: true, pixelRatio: 2 })
            .then((dataUrl) => {
                ...
                link.download = `${username}-intuition-bets-id.png`;
                link.href = dataUrl;
                link.click();
            })
            .catch((err) => {
        ...
        <>
            <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="relative bg-card/60 backdrop-blur-xl border border-border rounded-[2.5rem] p-6 flex flex-col items-center justify-center gap-4 text-center">
                    ...
                    <p className="text-xs text-muted-foreground max-w-xs">Share your address to receive $TRUST or other assets on the INTUITION BETs chain.</p>
