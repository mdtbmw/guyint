...
>(
  (
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            side={side}
          >
            <SheetHeader className="p-0 absolute -left-[9999px]">
    ...
    return (
      <div
        ref={ref}
        className="group peer hidden w-full md:block text-sidebar-foreground"
        data-state={state}
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 p-3 group-data-[collapsible=icon]:items-center",
        className
      )}
      {...props}
    />
